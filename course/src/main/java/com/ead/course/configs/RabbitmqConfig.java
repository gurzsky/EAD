...
public class RabbitmqConfig {
    ...
    public RabbitTemplate rabbitTemplate() { // cria ponto de injecao dentro do publisher para enviar as mensagens/eventos
        RabbitTemplate template = new RabbitTemplate(cachingConnectionFactory); // conecta instancia com o Rabbitmq usando o endereço definido no application-dev.yaml
